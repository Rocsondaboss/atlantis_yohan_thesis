  ...
  <body>
      ...
      <div class="jumbotron">
        <div class="col-sm-8 mx-auto">
          <h1>Register</h1>
           <p style="background-color: green; text-align: center; color:white"><b>Payment successful! OK to board the vessel.<br />To make another transaction, <a href="passengersPayFareIndex.php">click here</a> to go back to fare payment.</b></p>
